...
// 1. Collect all your SVGs as React components (either via SVGR or inline)
...
// (You’d do the same for Instagram, TikTok, Twitter, etc.)
...
// 2. Map string → component
const PLATFORM_ICONS: Record<string, React.FC<SVGProps<SVGSVGElement>>> = {
...
//       <PlatformIcon key={p} platform={p} className="w-6 h-6" />
//     ))}
